                                        ...
                                        <div class="table-responsive">
                                             <table class="table align-middle mb-0 table-hover table-centered">
                                                  <thead class="bg-light-subtle">
                                                       <tr>
                                                            <th class="text-center" style="width: 50px;">Icon</th>
                                                            <th class="text-start" style="width: 200px;">Categories</th>
                                                            <th class="text-center" style="width: 80px;">Products</th>
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            <td class="text-center">
                                                                 <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center mx-auto">

                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center">
                                <div class="hero-slide-content slider-animated-1">
                                    ...
                                    <p>{{ $p->description }}</p>
                                    <a href="#" class="btn btn-lg btn-primary btn-hover-dark mt-5">Shop</a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5">
                                <div class="hero-slide-image" style="width: clamp(220px, 45vw, 420px); aspect-ratio: 1 / 1; position: relative; overflow: hidden; border-radius: 12px; margin: 0 auto;">
                                    <img src="{{ asset('storage/' . ltrim($p->image, '/')) }}" alt="" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; object-position: center; display: block;" />
                                </div>
                            </div>
                        </div>
                    </div>
